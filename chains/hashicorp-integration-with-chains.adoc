...
*NOTE*
  ...
  * If not done, you can login into the vault provider and run the following
command
...
----
  ...
  * You can get more info about `transit` secrets https://developer.hashicorp.com/vault/docs/secrets/transit#setup[here]
